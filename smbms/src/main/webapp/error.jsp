...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: url("${pageContext.request.contextPath }/images/blueprint.png") repeat 0 0;
        }
        ...
        div.da-error-wrapper .da-error-code {
            ...
            font-size: 32px;
            text-align: center;
            background: url("${pageContext.request.contextPath }/images/error-hanger.png") no-repeat center center;
        ...
        div.da-error-wrapper .da-error-pin {
            ...
            z-index: 10;
            position: relative;
            background: url("${pageContext.request.contextPath }/images/error-pin.png") no-repeat center center
        }
    ...
    <div class="da-content">
        <div class="da-container clearfix">
            <div class="da-error-wrapper">
                ...
                <h1 class="da-error-heading"><a id="backTo" href="login.jsp">点我返回登录页面！</a></h1>
            </div>
        </div>
    </div>
</div>
